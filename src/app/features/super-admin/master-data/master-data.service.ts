...
export const MASTER_ENDPOINTS: Record<string, MasterEndpoint> = {
  ...
  billingCycles: { getAll: 'getallbillingcycle', create: 'createbillingcycle', update: 'updatebillingcycle', delete: 'deletebillingcycle' },
  contactTypes: { getAll: 'getallcontacttype', create: 'createcontacttype', update: 'updatecontacttype', delete: 'deletecontacttype' },
  relationships: { getAll: 'getallrelationship', create: 'createrelationship', update: 'updaterelationship', delete: 'deleterelationship' },
  companyTypes: { getAll: 'getallcompanytype', create: 'createcompanytype', update: 'updatecompanytype', delete: 'deletecompanytype' },
  leadTypes: { getAll: 'getallleadtype', create: 'createleadtype', update: 'updateleadtype', delete: 'deleteleadtype' },
  licenses: { getAll: 'getalllicense', create: 'createlicense', update: 'updatelicense', delete: 'deletelicense' },
  discountTypes: { getAll: 'getalldiscounttype', create: 'creatediscounttype', update: 'updatediscounttype', delete: 'deletediscounttype' },
  meetingPurposes: { getAll: 'getallmeetingpurpose', create: 'createmeetingpurpose', update: 'updatemeetingpurpose', delete: 'deletemeetingpurpose' },
  callPurposes: { getAll: 'getallcallpurpose', create: 'createcallpurpose', update: 'updatecallpurpose', delete: 'deletecallpurpose' },
